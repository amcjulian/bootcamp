...
//descripcion: Ejercicio 1: Iteracion de elementos con el metodo forEach

//////////////////////////////////////////////////////////////////////////////////////////
const iterateUsers = () => {
  //Listado de usuarios copiada del archivo users.json
  const user = [{"user_id":1,"first_name":"Peadar","last_name":"Popeley","age":24,"email":"ppopeley0@usnews.com","country":"China","favorite_color":"green","gender":"Male","shirt_size":"2XL"},
...
// Ejecucion funcion iterateUsers()
iterateUsers();
